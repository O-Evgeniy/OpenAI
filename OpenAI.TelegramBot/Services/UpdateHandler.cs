...
public class UpdateHandler : IUpdateHandler
{
    ...
    private async Task BotOnMessageReceived(Message message, CancellationToken cancellationToken)
    {
        ...
        {
            "дополни" => SendOpenAiKeyboard(_botClient, message, cancellationToken),
            "/completion"=> SendOpenAiKeyboard(_botClient, message, cancellationToken),
            "/openai" => SendOpenAiKeyboard(_botClient, message, cancellationToken),
            ...
            CancellationToken cancellationToken)
        {
            const string usage = "Usage:\n" +
                                 "/openai - send completion request to OpenAI\n" +
        ...
        static async Task<Message> StartInlineQuery(ITelegramBotClient botClient, Message message,
            CancellationToken cancellationToken)
        {
            InlineKeyboardMarkup inlineKeyboard =new(InlineKeyboardButton.WithSwitchInlineQueryCurrentChat("Inline Mode"));
    ...
    private async Task<Message> SendOpenAiKeyboard(ITelegramBotClient botClient, Message message,
        CancellationToken cancellationToken)
    {
        await botClient.SendChatActionAsync(
            chatId: message.Chat.Id,
        ...
        var response = await _completionClient.CreateCompletion(new CreateCompletionRequest()
        {
